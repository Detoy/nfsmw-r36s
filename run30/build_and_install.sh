#!/bin/sh
# Run 30 - build the mapper with the same GCC cross toolchain used for runs
# 1-29 and install it on the mounted R36S card.
#
# Usage:  sh "run30/build_and_install.sh"
#
