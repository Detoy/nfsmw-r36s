#!/bin/sh
# Run 32 - build the mapper with the same GCC cross toolchain used for runs
# 1-31 and install it on the mounted R36S card.
#
# Usage:  sh "run32/build_and_install.sh"
#
